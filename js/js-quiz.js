...
var quiz = {
  ...
  // quiz.submit() : Handle the calculations when the user submits to quiz
    ...
    var html = "<h1>";
    if (percent>=0.6) {
      html += "YOU ARE IN LARGE RISK OF INFECTION";
    } else if (percent>=0.3) {
      html += "AND IF YOU ARE INFECTED YOU WILL NOT BE ANYTHING";
    } else {
      html += "YOU ARE LIKELY NOT TO BE INFECTED";
    }
    html += "</h1>";
    html += "<div>IT IS POSSIBLE THAT YOU CAN INFECT IT " + score*20+ "%"+ " FROM THE POSSIBLE " + total*20+"%"+ ".</div>";
